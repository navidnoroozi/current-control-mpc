...
def simPowerConvControlSyst(
    ...
    I_ref_peak, phi_ref = powerCurrentHandler.calculateCurrentMagnitudeAndPhase(phase_num)
    ...
    if phase_num == 1:
        ...
        s_traj, i_a_traj, i_ref_traj, t_sim, cost_func_val = sim_executor(
            load, inverter, mpc, currentReference, s0, t_0, i_a_0, 
            sampling_rate, sim_time, phase_num
        )
        ...
        ## Placeholder for Balanced Three Phase Case
        pass
